#!/usr/bin/env python3
"""Compare all trained DAVO models"""
...
models = {
    "Phi-3.5 (4B)": "models/fine-tuned/phi35_davo_v1",
    "Llama 3.2 (3B)": "models/fine-tuned/llama32_3b_davo_v1"
}
...
for model_name, model_path in models.items():
    ...
    for test in test_cases:
        ...
        print(f"  {test['name']}: {priority} {correct}")
...
for model_name in models.keys():
    ...
    if len(model_results) > 0:
        ...
        print(f"\n{model_name}: {accuracy:.1f}% accuracy")
